...
function crearUsuario() {
   ...
   // Retornar la clase.
   // Tu código: primero la manera de ahcerlo con la funcion constructora, 2da la forma de hacerlo con la sintaxis de clases
...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function() {
      ...
      for (let i = this.length -1; i >= 0; i--){
         stringInvertida += this [i] //le suma el caracter por cada iteracion q haga
       }
